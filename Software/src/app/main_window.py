...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self._profile_list = ProfileList(self.profiles, self.current_profile, self)
        self._profile_data = ProfileData(self.profiles[self.current_profile], self)
        self._encoder = Encoder(self.profiles[self.current_profile], self)
        self._shokey = Shokey(self.profiles[self.current_profile], self)
    ...
    def get_profiles(self):
        with open("src/profiles.json", "r") as file:
